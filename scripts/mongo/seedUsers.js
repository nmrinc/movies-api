...
/**
 *@context This script insert mock users into the mongo DB
 *--
 ...
 *--
 *@o Development
 *@test >DEBUG=app:* NODE_ENV=dev node scripts/mongo/seedUsers.js
 *--
 *@o Production
 *@test >DEBUG=app:* NODE_ENV=production node scripts/mongo/seedUsers.js
*/
